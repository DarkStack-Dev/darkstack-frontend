...
import { handleGoogleStart } from "@/lib/server/auth";
...
export const GoogleButton = ({ 
    ...
    const handleGoogleAuth = async () => {
        ...
        try {
            const response = await handleGoogleStart(state);
            ...
            toast.error('Erro ao conectar com Google', { position: "bottom-right" });
            setLoading(false);
        }
    };
